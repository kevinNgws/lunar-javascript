...
const currentBzResult = {
  ...
  yearDiZhiShiShen: getDiZhiShiShen(bz.getDayGan(), bz.getYearZhi(), getDiZhiCangGan(bz.getYearZhi())),
  yearDiZhiCangGanShiShen: getCangGanShiShen(
    getDiZhiCangGan(bz.getYearZhi()),
    getDiZhiShiShen(bz.getDayGan(), bz.getYearZhi(), getDiZhiCangGan(bz.getYearZhi())),
  ),
  ...
  monthDiZhiShiShen: getDiZhiShiShen(bz.getDayGan(), bz.getMonthZhi(), getDiZhiCangGan(bz.getMonthZhi())),
  monthDiZhiCangGanShiShen: getCangGanShiShen(
    getDiZhiCangGan(bz.getMonthZhi()),
    getDiZhiShiShen(bz.getDayGan(), bz.getMonthZhi(), getDiZhiCangGan(bz.getMonthZhi())),
  ),
  ...
  dayDiZhiShiShen: getDiZhiShiShen(bz.getDayGan(), bz.getDayZhi(), getDiZhiCangGan(bz.getDayZhi())),
  dayDiZhiCangGanShiShen: getCangGanShiShen(
    getDiZhiCangGan(bz.getDayZhi()),
    getDiZhiShiShen(bz.getDayGan(), bz.getDayZhi(), getDiZhiCangGan(bz.getDayZhi())),
  ),
  ...
  timeDiZhiShiShen: getDiZhiShiShen(bz.getDayGan(), bz.getTimeZhi(), getDiZhiCangGan(bz.getTimeZhi())),
  timeDiZhiCangGanShiShen: getCangGanShiShen(
    getDiZhiCangGan(bz.getTimeZhi()),
    getDiZhiShiShen(bz.getDayGan(), bz.getTimeZhi(), getDiZhiCangGan(bz.getTimeZhi())),
  ),
};
// console.log("currentBzResult", currentBzResult);
// displayBz(currentBzResult);
console.log(
  `${year}-${month.toString().padStart(2, 0)}-${day.toString().padStart(2, 0)} ${hour.toString().padStart(2, 0)}:${min
    .toString()
...
const prevBz = prevJq.getSolar().getLunar()
  .getEightChar();
// console.log(
//   `上一节气: ${prevJq
//     .getSolar()
...
for (var i = 0, j = jqList.length; i < j; i++) {
  ...
  if (name === prevJq.getName()) {
    ...
    newMonthDiShi = getDiShi(prevPrevBz.getMonthGan(), prevPrevBz.getMonthZhi());
    newMonthTianGanShiShen = getTianGanShiShen(currentBzResult.dayTianGan, prevPrevBz.getMonthGan());
    newMonthDiZhiCangGan = getDiZhiCangGan(prevPrevBz.getMonthZhi());
    newMonthDiZhiShiShen = getDiZhiShiShen(bz.getDayGan(), prevPrevBz.getMonthZhi(), getDiZhiCangGan(prevPrevBz.getMonthZhi()));
    newMonthDiZhiCangGanShiShen = getCangGanShiShen(
      getDiZhiCangGan(prevPrevBz.getMonthZhi()),
      getDiZhiShiShen(bz.getDayGan(), prevPrevBz.getMonthZhi(), getDiZhiCangGan(prevPrevBz.getMonthZhi())),
    );
  }
}
const newBzResult = {
